...
import 'pyjamas_product_copy_copy_model.dart';
export 'pyjamas_product_copy_copy_model.dart';

class PyjamasProductCopyCopyWidget extends StatefulWidget {
  const PyjamasProductCopyCopyWidget({Key? key}) : super(key: key);

  @override
  _PyjamasProductCopyCopyWidgetState createState() =>
      _PyjamasProductCopyCopyWidgetState();
}

class _PyjamasProductCopyCopyWidgetState
    extends State<PyjamasProductCopyCopyWidget> {
  late PyjamasProductCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PyjamasProductCopyCopyModel());
  }

...
import 'pyjamas_product_copy_model.dart';
export 'pyjamas_product_copy_model.dart';

class PyjamasProductCopyWidget extends StatefulWidget {
  const PyjamasProductCopyWidget({Key? key}) : super(key: key);

  @override
  _PyjamasProductCopyWidgetState createState() =>
      _PyjamasProductCopyWidgetState();
}

class _PyjamasProductCopyWidgetState extends State<PyjamasProductCopyWidget> {
  late PyjamasProductCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PyjamasProductCopyModel());
  }
